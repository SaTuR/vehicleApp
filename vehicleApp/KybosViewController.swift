...
class KybosViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad()
        disableResizing()
        titleLabel.text="KYBOS"
        
        imageView1.image = UIImage(named: "kybos1")
        imageView2.image = UIImage(named: "kybos2")
        imageView3.image = UIImage(named: "kybos3")
        imageView4.image = UIImage(named: "kybos4")
        
        imageView1.image = #imageLiteral(resourceName: "kybos1")
        imageView2.image = #imageLiteral(resourceName: "kybos2")
        imageView3.image = #imageLiteral(resourceName: "kybos3")
        imageView4.image = #imageLiteral(resourceName: "kybos4")
